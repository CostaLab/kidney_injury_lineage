...
conf = c(
       scrna_phase_comparing_PTs_anno    = 2, ## DE GO pathway analysis etc. All rest calculating will be stored here
...
scrna_remove_clusters = c("PT4", "PT7", "PT8")
scrna_remove_recluster = c("PT4", "PT7", "PT8")
